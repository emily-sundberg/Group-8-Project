...
```{=html}
<iframe width="900" height="650" src="./output/AI_byState.html" title="Number of AI Job Postings by State"></iframe>
```
...
```{=html}
<iframe width="900" height="650" src="./output/AI_industries.html" title="Number of AI Job Postings by Industry"></iframe>
```