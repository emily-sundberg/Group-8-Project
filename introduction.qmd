...
<!-- Live interactive map (works on your published HTML site) -->
<iframe 
  src="https://www.aauw.org/resources/article/gender-pay-gap-by-state/" 
  width="100%" 
  height="650" 
  style="border:none" 
  loading="lazy"
  title="AAUW 2025 Gender Pay Gap by State">
</iframe>

<!-- Optional PDF fallback (uncomment if you save a PNG locally)
![AAUW 2025 Gender Pay Gap Map](figures/aauw_gender_gap_map_2025.png)
-->
